      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
              <a class="btn btn-primary btn-round text-white pull-right" href="{{ route('users.create') }}">{{ __('Add user') }}</a>
                  ...
                  <tr>
                    ...
                    <td>{{ $user->created_at->diffForHumans() }}</td>
                      ...
                      @if($user->id!=auth()->user()->id)
                        <a type="button" href="{{route("users.edit",$user)}}" rel="tooltip" class="btn btn-success btn-icon btn-sm " data-original-title="" title="">
